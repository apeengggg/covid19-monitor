    ...
    <div class="row">
        ...
        <fieldset class="border p-2">
            ...
            <div class="mb-6 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control mb-2" id="tgl_input" name="tgl_input" value="<?=date('d-m-y')?>" disabled>
                </div>
            </div>
            <div class="mb-6 row">
                <label for="nama" class="col-sm-2 col-form-label">Nama Pasien</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control mb-2" id="nama_pasien" name="nama_pasien" value="<?=$result['nama']?>" disabled>
                </div>
            </div>
            <div class="mb-6 row">
                <label for="kode" class="col-sm-2 col-form-label">No Pasien</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kode_pasien" name="kode_pasien" value="<?=$result['kode_pasien']?>" readonly>
                </div>
            </div>
            <div class="mt-2 row">
                <label for="usia" class="col-sm-2 col-form-label">Usia</label>
                <div class="col-sm-10">
                    <input type="number" class="form-control mb-2" id="usia" name="usia" value="<?=$result['usia']?>" readonly>
                </div>
            </div>
            <div class="mt-1 row">
                ...
                <div class="col-sm-10">
                    ...
                    <button type="submit" name="addstatuspasien" id="addstatuspasien" class="btn btn-md btn-dark">Tambah Status Pasien</button>
                </div>
            </div>
        </fieldset>
        </div>
    ...
    <div class="row">
        ...
        <fieldset class="border p-2">
            ...
            <div class="mt-2 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control mb-2" id="tanggal_input" name="tanggal_input" value=<?=date('d-m-y')?> disabled>
                </div>
            </div>
            <div class="mb-6 row">
                <label for="nama" class="col-sm-2 col-form-label">No Pasien</label>
                <div class="col-sm-10">
                    <select name="kode_pasien" id="kode_pasien" class="form-control mb-2" onchange='changeValue(this.value)' required>
            ...
            <div class="mt-1 row">
                ...
                <div class="col-sm-10">
                    ...
                    <button type="submit" name="addstatuspasien" id="addstatuspasien" class="btn btn-md btn-dark">Tambah Pasien</button>
                </div>
            </div>
        </fieldset>
        </div>
  ...
  <?php   
    echo $a; ?>  
      function changeValue(id){  
        document.getElementById('usia').value = usia[id].usia;    
      };  
</script>  
<?php
}
